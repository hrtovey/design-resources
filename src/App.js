            ...
            <header className={this.state.isActive ? "active" : ""}>
              ...
              <div className="categories">
                ...
                <nav className="primary-nav">
                  ...
                  <NavLink to="/inspiration" onClick={this.closeMenu}>
                    <svg
                      className="nav-icon"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 352 512"
                  ...
                  <NavLink to="/typography" onClick={this.closeMenu}>
                    <svg
                      className="nav-icon"
                      width="100%"
                      height="100%"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path d="M95.26,0l0,27.059l-2.655,0c-1.572,-6.242 -3.317,-10.728 -5.234,-13.456c-1.917,-2.728 -4.547,-4.903 -7.89,-6.525c-1.867,-0.885 -5.136,-1.327 -9.806,-1.327l-7.446,0l0,77.122c0,5.112 0.282,8.307 0.847,9.585c0.566,1.278 1.672,2.396 3.318,3.355c1.647,0.958 3.896,1.437 6.747,1.437l3.317,0l0,2.729l-52.348,0l0,-2.729l3.318,0c2.9,0 5.235,-0.516 7.004,-1.548c1.278,-0.688 2.286,-1.868 3.023,-3.539c0.541,-1.18 0.811,-4.276 0.811,-9.29l0,-77.122l-7.225,0c-6.735,0 -11.625,1.425 -14.673,4.276c-4.276,3.982 -6.98,9.659 -8.11,17.032l-2.802,0l0,-27.059l89.804,0Z" />
                    </svg>{" "}
                    Typography
                  </NavLink>
                  <NavLink to="/design-tools" onClick={this.closeMenu}>
                    <svg
                      className="nav-icon"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                  ...
                  <NavLink to="/graphics" onClick={this.closeMenu}>
                    <svg
                      className="nav-icon"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 640 512"
              ...
              <Route
                ...
                render={props => (
                  <ResourcesPage
                    {...props}
                    state={{
                      resources: this.state.resources.inspiration,
                      favorited: this.state.favorited
                    }}
                    addToFavorites={this.addToFavorites}
                  />
              ...
              <Route
                ...
                render={props => (
                  <ResourcesPage
                    {...props}
                    state={{
                      resources: this.state.resources.designTools,
                      favorited: this.state.favorited
                    }}
                    addToFavorites={this.addToFavorites}
                  />
              ...
              <Route
                ...
                render={props => (
                  <ResourcesPage
                    {...props}
                    state={{
                      resources: this.state.resources.typography,
                      favorited: this.state.favorited
                    }}
                    addToFavorites={this.addToFavorites}
                  />
              ...
              <Route
                ...
                render={props => (
                  <ResourcesPage
                    {...props}
                    state={{
                      resources: this.state.resources.graphics,
                      favorited: this.state.favorited
                    }}
                    addToFavorites={this.addToFavorites}
                  />
